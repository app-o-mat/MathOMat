...
class MathPongPlayer {
    ...
    func addButton(scene: SKScene, xPos: CGFloat, text: String, lineOffset: CGFloat) -> ColorButtonNode {
    ...
    func addButtons(scene: SKScene, problem: Problem, lineOffset: CGFloat) -> [ColorButtonNode] {
